...
puntuaciones_worksheet = puntuaciones_workbook.worksheet('2024-MARZO')
...
# If the index of similarity is greater than 0.6, assign the author name in the column 3 of the sheet
    if max_similarity > 0.0:
        ...
        puntuaciones_worksheet.update_cell(i + 2, 3, nearest_author_name)
        puntuaciones_worksheet.update_cell(i + 2, 4, max_similarity)
