...
function loadImageAsimageLayer(sourceFile, savePath) {
	...
	// if horizontal or vertical but applying yScale would exceed target width size: scale horizontal, else scale vertical
    if ( aspectRatio > 1 || (imageLayerWidth * yFactor  >  targetWidth) ) { 
	...
	if (newImageLayerWidth + 0.05 < targetWidth) {
		//alert("newImageLayerWidth =" +newImageLayerWidth + " targetWidth="+ targetWidth);
